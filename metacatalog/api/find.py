...
@overload
def find_group(return_iterator: Literal[False] = False) -> List['EntryGroup']: ...
@overload
def find_group(return_iterator: Literal[True] = False) -> 'Query': ...
def find_group(session: 'Session', id: Optional[int] = None, uuid: Optional[str] = None, title: Optional[str] = None, type: Union[int, str] = None, return_iterator: bool = False, as_result: bool = False) -> 'Query' | List['EntryGroup']:
    """
...
@overload
def find_entry(return_iterator: Literal[False] = False) -> List['Entry']: ...
@overload
def find_entry(return_iterator: Literal[True] = False) -> 'Query': ...
def find_entry(
    session: 'Session', 
    id: Optional[int] = None, 
    uuid: Optional[str] = None, 
